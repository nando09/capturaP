	...
	//identifica browser e seta variï¿½veis especï¿½cas p/os mesmos
	...
	function PutLayerX(theLayer){
		if ( vWidthLayer < vBrowsermouseposX ) { //layer ï¿½ esquerda do cursor
			vNewLayerPosX = vBrowsermouseposX - vWidthLayer - vSpaceLayerCursor;
		} else {// layer ï¿½ direita do cursor
	...
	//mostra o layer na posiÃ§Ã£o correta
